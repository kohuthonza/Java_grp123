...
public class GUImenu extends javax.swing.JFrame {
    ...
    private void jSpinner1StateChanged(javax.swing.event.ChangeEvent evt) {                                       
        ...
        if(jRadioButton1.isSelected() && (jRadioButton6.isSelected() || jRadioButton5.isSelected() || jRadioButton4.isSelected() || jRadioButton7.isSelected() || jRadioButton8.isSelected())){ //2 hraci
            if(value>=1 && value<=12){
                jButton1.setEnabled(true);
            }
        }
        else if(jRadioButton2.isSelected()){ //3 hraci
            if(value>=1 && value<=6){
                jButton1.setEnabled(true);
            }                
        }
        else if(jRadioButton3.isSelected()){ // 4 hraci
            if(value>=1 && value<=8){
                jButton1.setEnabled(true);
            }                
        }
